<template>
  <q-page class="q-pa-md items-center justify-evenly">
          ...
          <q-card class="my-card" square>
            ...
            <q-card-section>
              <div class="row items-center no-wrap">
                ...
                <div class="col-auto">
                  <q-btn square color="grey-7" round flat icon="mdi-dots-vertical">
    ...
    <q-page-sticky v-if="$q.screen.lt.sm" position="bottom-right" :offset="[18, 18]">
      <q-btn fab icon="mdi-plus" color="primary" @click="createProjectForm = true" />
    </q-page-sticky>
...
<script lang="ts">
import ProjectListSetup from './project-list-setup';
